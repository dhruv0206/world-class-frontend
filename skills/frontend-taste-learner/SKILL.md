...
4. Build a list of 5–15 new sites to analyze this run. Prioritize:
...
### Phase 2: Analysis — Watch, Inspect, Understand

For each site in your list, do the following:
...
After each run, the knowledge base should have:
- At least 3 new site-analyses files
- An updated CHANGELOG.md entry
- Incremented version number
- At least one update to animation-patterns.md or library-guide.md
